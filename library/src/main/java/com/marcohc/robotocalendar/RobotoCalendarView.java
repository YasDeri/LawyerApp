...
public class RobotoCalendarView extends LinearLayout {
    ...
    private static final String DAY_OF_THE_MONTH_CIRCLE_IMAGE_MEETING = "dayOfTheMonthCircleImageMeeting";
    private static final String DAY_OF_THE_MONTH_CIRCLE_IMAGE_HEARING = "dayOfTheMonthCircleImageHearing";
    private static final String DAY_OF_THE_MONTH_CIRCLE_IMAGE_DEADLINE = "dayOfTheMonthCircleImageDeadline";
    ...
    public void clearSelectedDay() {
        if (lastSelectedDayCalendar != null) {
           ...
           /* if (nowCalendar.get(Calendar.YEAR) == lastSelectedDayCalendar.get(Calendar.YEAR) && nowCalendar.get(Calendar.DAY_OF_YEAR) == lastSelectedDayCalendar.get(Calendar.DAY_OF_YEAR)) {
            ...
            ImageView circleImageMeeting = getCircleImageMeeting(lastSelectedDayCalendar);
            ImageView circleImage2 = getCircleImageHearing(lastSelectedDayCalendar);
           /* if (circleImage1.getVisibility() == VISIBLE) {
    ...
    public void markCircleImage1(@NonNull Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        ImageView circleImage1 = getCircleImageMeeting(calendar);
    ...
    public void markDeadline(@NonNull Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        ImageView circleImage1 = getCircleImageDeadline(calendar);
        circleImage1.setVisibility(View.VISIBLE);
        if (lastSelectedDayCalendar != null && areInTheSameDay(calendar, lastSelectedDayCalendar)) {
            DrawableCompat.setTint(circleImage1.getDrawable(), ContextCompat.getColor(getContext(), R.color.roboto_calendar_selected_day_font));
        } else {
            DrawableCompat.setTint(circleImage1.getDrawable(), ContextCompat.getColor(getContext(), R.color.yellowdot));
        }
    }


    public void markMeeting(@NonNull Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        ImageView circleImage1 = getCircleImageMeeting(calendar);
        circleImage1.setVisibility(View.VISIBLE);
        if (lastSelectedDayCalendar != null && areInTheSameDay(calendar, lastSelectedDayCalendar)) {
            ...
            DrawableCompat.setTint(circleImage1.getDrawable(), ContextCompat.getColor(getContext(), R.color.bluedot));
        }
    }

    public void markHearing(@NonNull Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        ImageView circleImage1 = getCircleImageHearing(calendar);
        circleImage1.setVisibility(View.VISIBLE);
        if (lastSelectedDayCalendar != null && areInTheSameDay(calendar, lastSelectedDayCalendar)) {
            DrawableCompat.setTint(circleImage1.getDrawable(), ContextCompat.getColor(getContext(), R.color.roboto_calendar_selected_day_font));
        } else {
            DrawableCompat.setTint(circleImage1.getDrawable(), ContextCompat.getColor(getContext(), R.color.reddot));
        }
    }
    ...
    public void markCircleImage2(@NonNull Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        ImageView circleImage2 = getCircleImageHearing(calendar);
    ...
    private void findViewsById(View view) {
        ...
        for (int i = 0; i < 42; i++) {
            ...
            View dayOfTheMonthCircleImageMeeting = dayOfTheMonthLayout.findViewWithTag(DAY_OF_THE_MONTH_CIRCLE_IMAGE_MEETING);
            View dayOfTheMonthCircleImageHearing = dayOfTheMonthLayout.findViewWithTag(DAY_OF_THE_MONTH_CIRCLE_IMAGE_HEARING);
            View dayOfTheMonthCircleImageDeadline = dayOfTheMonthLayout.findViewWithTag(DAY_OF_THE_MONTH_CIRCLE_IMAGE_DEADLINE);
            ...
            dayOfTheMonthCircleImageMeeting.setTag(DAY_OF_THE_MONTH_CIRCLE_IMAGE_MEETING + viewIndex);
            dayOfTheMonthCircleImageHearing.setTag(DAY_OF_THE_MONTH_CIRCLE_IMAGE_HEARING + viewIndex);
            dayOfTheMonthCircleImageDeadline.setTag(DAY_OF_THE_MONTH_CIRCLE_IMAGE_DEADLINE + viewIndex);
    ...
    private void setUpDaysOfMonthLayout() {
        ...
        View circleImageMeeting;
        View circleImageHearing;
        View circleImageDeadline;
        ...
        for (int i = 1; i < 43; i++) {
            ...
            circleImageMeeting = rootView.findViewWithTag(DAY_OF_THE_MONTH_CIRCLE_IMAGE_MEETING + i);
            circleImageHearing = rootView.findViewWithTag(DAY_OF_THE_MONTH_CIRCLE_IMAGE_HEARING + i);
            circleImageDeadline= rootView.findViewWithTag(DAY_OF_THE_MONTH_CIRCLE_IMAGE_DEADLINE + i);

            dayOfTheMonthText.setVisibility(View.INVISIBLE);
            circleImageMeeting.setVisibility(View.GONE);
            circleImageHearing.setVisibility(View.GONE);
            circleImageDeadline.setVisibility(View.GONE);
    ...
    private ImageView getCircleImageMeeting(Calendar currentCalendar) {
        return (ImageView) getView(DAY_OF_THE_MONTH_CIRCLE_IMAGE_MEETING, currentCalendar);
    }

    private ImageView getCircleImageHearing(Calendar currentCalendar) {
        return (ImageView) getView(DAY_OF_THE_MONTH_CIRCLE_IMAGE_HEARING, currentCalendar);
    }

    private ImageView getCircleImageDeadline(Calendar currentCalendar) {
        return (ImageView) getView(DAY_OF_THE_MONTH_CIRCLE_IMAGE_DEADLINE, currentCalendar);
    }
