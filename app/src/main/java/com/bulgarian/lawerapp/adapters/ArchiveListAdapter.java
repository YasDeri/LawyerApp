...
public class ArchiveListAdapter extends RecyclerView.Adapter<ArchiveListAdapter.ViewHolder> {
    ...
    public ArchiveListAdapter(List<CaseListGetSet> getDataAdapter, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.archive_list_adapter, parent, false);
    ...
    public void onBindViewHolder(ViewHolder Viewholder, int position) {
        ...
        Viewholder.case_deadline.setText(dataAdapterOBJ.getType_judgment_no()
                + " / " + dataAdapterOBJ.getTook_effect());
